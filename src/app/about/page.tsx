          ...
          <div>
            ...
            >
              <h1 className='p-2 font-light tracking-wider text-lg z-10'>
                ...
                with comprehensive experience of 1.5 years across{" "}
                <span className='dark:text-yellow-400 text-yellow-500'>
                  Frontend, Backend, and DevOps.
                </span>{" "}
                Specialized in architecting scalabase full-stack applications
                and integrative
                <span className='dark:text-orange-400 text-orange-500'>
                  Retrieval-Augmented Generation (RAG) pipelines for AI-driven
                  solutions.
                </span>
                Proven track record of optimizing cloud infrastructure to reduce
                costs by 30% while delivering secure, high-performance systems.
              </h1>
            </PointerHighlight>
          </div>
          {/* Horizontal Line */}
