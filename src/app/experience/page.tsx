  ...
  const data = [
      ...
      content: (
        <div>
          <div className='flex flex-col gap-2'>
            <h1 className='text-xl md:text-4xl dark:text-yellow-300 text-yellow-700'>DevOps Engineer</h1>
            <a className='text-md md:text-xl dark:text-blue-200 text-blue-800 hover:underline' href="https://sirpi.io" target="_blank">
    ...
    },
    {
      ...
      content: (
        <div>
          <div className='flex flex-col gap-2'>
            <h1 className='text-xl md:text-4xl dark:text-yellow-300 text-yellow-700'>DevOps Intern</h1>
            <a className='text-md md:text-xl dark:text-blue-200 text-blue-800 hover:underline' href="https://sirpi.io" target="_blank">
              SIRPI Products and Services Pvt. Ltd.
            </a>
          </div>
    ...
    },
    {
      ...
      content: (
        <div>
          <div className='flex flex-col gap-2'>
            <h1 className='text-xl md:text-4xl dark:text-yellow-300 text-yellow-700'>Frontend Engineer</h1>
            <a className='text-md md:text-xl dark:text-blue-200 text-blue-800 hover:underline' href="https://sirpi.io" target="_blank">
              SIRPI Products and Services Pvt. Ltd.
            </a>
          </div>
