    ...
    <div className='flex flex-col justify-center items-center w-full'>
      ...
      <div className=' text-left'>
        <motion.div
          ...
          className='border text-2xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-black/40 to-black dark:from-white/85 dark:to-gray-50/40'
        >
          Experience
        </motion.div>
      </div>
